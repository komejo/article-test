...
cd web;drush si --site-name="article-test" --db-url=mysql://root:root@localhost/article-test -y;cd ../
chmod 777 web/sites/default/s*
echo "\$settings['trusted_host_patterns'] = array('article-test\.dev$',);" >> web/sites/default/settings.php
